(function (){let answerCollection = [[1, 'Виявивши, що улюблені джинси розірвалися, ви:', 'викидаєте їх', 'робите кілька художніх розрізів і продовжуєте носити'],  //  0/1
...
function showAnswer(arr){
   ...
   document.querySelector('#question-1').checked = false
   document.querySelector('#question-2').checked = false
   l_1.innerText = arr[2]
   l_2.innerText = arr[3]
}
